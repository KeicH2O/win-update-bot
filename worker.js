 ...
 * Domain: https://win-update-bot.keich2o.workers.dev
 * Bindings required:
 *   - DB: D1 Database (win-update-bot)
 *   - AI: Cloudflare Workers AI
 *   - TELEGRAM_BOT_TOKEN: Secret or Env var (задан)
...
export default {
  ...
  async fetch(request, env, ctx) {
    ...
    const token = env.TELEGRAM_BOT_TOKEN || '8796153108:AAFTCSrIgd3E9qTm1Lh79dKgLHy3O8BAlRk';
